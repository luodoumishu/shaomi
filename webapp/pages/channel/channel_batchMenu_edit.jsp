...
<div id="DataTab">
    ...
    <form id="dataform" name="dataform" method="post">
        ...
        <input type="hidden" data-bind="value:menuName" />
         <input type="hidden" data-bind="value:menuId" />
          <input type="hidden" data-bind="value:channelId" />
           <input type="hidden" data-bind="value:channeName" />
            <table class="xjj-table-detail" border="0" cellspacing="0" cellpadding="0">
               <tr>
                    <th width="100">频道项名称&nbsp;<span><font color="red"></font>*</span></th>
                    <td>
                        <input id="channeItemName" class="k-textbox" required="required" validationMessage="请输入频道项名称" style="width: 95%" data-bind="value: channeItemName"/>
                    </td>
                </tr>
                <tr>
                    <th>排序号</th>
                	<td>
                    	<input id="sortno" name="sortno" data-bind="value: sortno" style="width: 180px"/>
                	</td>
                </tr>
            </table>
     </form>
...
<script type="text/javascript">
	...
	$("#submit_confirm").click(function () {
	    if (checkForm()) {
	        if (EditType == "edit") {
	            AjaxDoPost("${ctx}/CmsChannelItem/update.json", "models=" + JSON.stringify(Item), false, editSuccess, editError);
	        }
	    }
	});
	//Tab单项激活事件
