...
<body id="openId">
	<div id="menuInfoTab">
		...
		<div id="form-container-edit">
			<form:form id="dataform" name="dataform" modelAttribute="dataform" method="post" action="${ctx}/cms/article/saveOrUpdateHistory.json" enctype="multipart/form-data">
				<input type="hidden" id="id" name="id" data-bind="value:id" />
				<input type="hidden" id="check_log" name="check_log" data-bind="value:check_log" />
			...
			<div align="center">
				<button id="history_submit_confirm" class="k-button width70">保存</button>
				<button id="history_cancel"  class="k-button width70">退出</button>
			</div>
		</div>
	</div>
