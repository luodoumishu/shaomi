        ...
        $(document).ready(function () {
        	//创建工具栏按钮
          	var ToolbarHtml = new CreateToolBarButton({
                  GridId: "grid",
                  Url: "${ctx}/pages/win/season_info_edit.jsp",
                  Add: true,
                  Edit: true,
                  Del: true
              });
          ...
          //数据源
       	  dataSource = CreateGridDataSource({
       	    Transport: {
                 ReadUrl: "${ctx}/win/SeasonInfo/list.json",
            ...
            Filterable: false,    
            Columns: [ 
                      { field: "name",width: "40%",title: "赛季名称"},
                      { field: "leagueInfoName",width: "40%",title: "所属联赛"},
                      { field: "gameRound",width: "10%",title: "赛季比赛轮数"},
        ...
        onDelete = function () {
         ...
         del = function () {
            ...
            if (typeof (data) != undefined) {
            	AjaxDoPost("${ctx}/win/SeasonInfo/delete.json","models=" + JSON.stringify(data),true,deleteSuccess, deleteError);
            }
        }
