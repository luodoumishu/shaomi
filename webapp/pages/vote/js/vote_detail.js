...
xjj.cms.vote = (function(){
	...
	var ToolbarHtml = new CreateToolBarButton({
        GridId: "grid",
        Url: path+"/pages/vote/vote_detail_edit.jsp",
        Add: true,
        Edit: true,
        Del: true
 	});
	...
	dataSource = CreateGridDataSource({
 	    Transport: {
           ReadUrl: path+"/cms/vote/detail/list.json",
	...
	var init_listPage = function(){
	  ...
	  // 列表表格
	        grid = CreateGrid({
		        ...
		        Filterable: false,    
		        Columns: [ 
		                  { field: "detail_name",width: "10%",title: "投票项明细名称"},
		                  { field: "vote_num",width: "10%",title: "投票数"},
	...
	var  checkForm =  function () {
	  ...
	  $("#cancel").click(function(){
		  window.location.href= path+"/pages/vote/vote_detail_list.jsp";
	      closewindow("div");
	  });
	  //监听保存按钮
...
var  onDelete = function () {
 ...
 var del = function () {
     ...
     if (typeof (data) != undefined) {
     	AjaxDoPost(path+"/cms/vote/detail/delete.json","models=" + JSON.stringify(data),true,xjj.cms.vote.deleteSuccess,xjj.cms.vote.deleteError);
     }
 };