    ...
    <div class="lg_main">
        ...
        <div class="lg_xzone">
	        ...
	        <div class="lg_xzhdp lg_l">
	        	...
	        	<div class="loading"><span>请稍候...</span></div>载入画面...
		            <ul class="pic"><!-- 内容列表 -->
		            	<chl:main chlCode="sq_tpxw" pageSize="4">
	        ...
	        <!-- 最新动态 -->
          	<div class="lg_xznews lg_r">
                <chl:main chlCode="sq_zxdt" pageSize="8">
        ...
        <div class="lg_xztwo">
            ...
            <div class="lg_xzbzgk lg_l">
                <chl:main chlCode="sq_djgz" pageSize="6">
            ...
            <div class="lg_xzbzgk lg_r">
                <chl:main chlCode="sq_zwgk" pageSize="6">
		        	<div class=lg_xzbztite>
		            	<chl:more>
				       		<span><a href="$_channel_more_uri" target="_blank"><img src="images/lg_more.png" width="45" height="19" /></a></span>
							<p>$_chl_name</p>
            ...
            <!--政策法规-->
            <div class="lg_xzbzgk lg_l">
                <chl:main chlCode="sq_zcfg" pageSize="6">
		        	<div class=lg_xzbztite>
		            	<chl:more>
				       		<span><a href="$_channel_more_uri" target="_blank"><img src="images/lg_more.png" width="45" height="19" /></a></span>
							<p>$_chl_name</p>
            ...
            <!--便民服务-->
            <div class="lg_xzbzgk lg_r">
            	<chl:main chlCode="sq_bmfw" pageSize="6">
		        	<div class=lg_xzbztite>
		            	<chl:more>
				       		<span><a href="$_channel_more_uri" target="_blank"><img src="images/lg_more.png" width="45" height="19" /></a></span>
							<p>$_chl_name</p>
