...
<div class="xz_box">
    <h1>| <%=orgName%></h1>
    <nav class="xz_cunm" id="childlist" style="max-height: 80px;overflow: auto;">
    </nav>
</div>
<!--乡镇 end-->
<div class="lg_top">
...
<div class="lg_navbox">
	...
	<div class="lg_timenav">
       	<div class="lg_login">
           	用户名：<input name="" type="text" class="lg_ipt1" />
                                    密码：<input name="" type="text"  class="lg_ipt1" />
            	<a href=""><img src="images/lg_login.png" width="57" height="23" /></a> 
        </div>
        <div class="lg_serch">
