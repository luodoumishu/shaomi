    ...
    <div class="lg_main">
        ...
        <div class="lg_xzone">
	        ...
	        <div class="lg_xzhdp lg_l">
	        	...
	        	<div class="loading"><span>请稍候...</span></div>载入画面...
		            <ul class="pic"><!-- 内容列表 -->
		            	<chl:main chlCode="z_tpxw" pageSize="4">
	        ...
	        <!-- 最新动态 -->
          	<div class="lg_xznews lg_r">
                <chl:main chlCode="z_zxdt" pageSize="8">
        ...
        <div class="lg_xztwo">
            ...
            <div class="lg_xzbzgk lg_l">
                <chl:main chlCode="z_djgz" pageSize="6">
            ...
            <div class="lg_xzbzgk lg_r">
                <chl:main chlCode="z_zwgk" pageSize="6">
		        	<div class=lg_xzbztite>
		            	<chl:more>
				       		<span><a href="$_channel_more_uri" target="_blank"><img src="images/lg_more.png" width="45" height="19" /></a></span>
							<p>$_chl_name</p>
            ...
            <!--政策法规-->
            <div class="lg_xzbzgk lg_l">
                <chl:main chlCode="z_zcfg" pageSize="6">
		        	<div class=lg_xzbztite>
		            	<chl:more>
				       		<span><a href="$_channel_more_uri" target="_blank"><img src="images/lg_more.png" width="45" height="19" /></a></span>
							<p>$_chl_name</p>
            ...
            <!--便民服务-->
            <div class="lg_xzbzgk lg_r">
            	<chl:main chlCode="z_bmfw" pageSize="6">
		        	<div class=lg_xzbztite>
		            	<chl:more>
				       		<span><a href="$_channel_more_uri" target="_blank"><img src="images/lg_more.png" width="45" height="19" /></a></span>
							<p>$_chl_name</p>
        ...
        <!--图文视窗  style="overflow:hidden;"-->
      	<div class="lg_twsc" style="margin-top: 5px;">
            <chl:main chlCode="z_twsc" pageSize="8">
	        	<div class=lg_twtite>
	            	<chl:more>
				        <span>
