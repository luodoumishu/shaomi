...
@Repository("LeagueInfoDao")
public class LeagueInfoDao extends BaseHibernateDao<LeagueInfo, String> implements ILeagueInfoDao{

	@Override
	public List<LeagueInfo> query(int skip, int pageSize,
		...
		// 调用框架提供的方法进行分页查询
		List<LeagueInfo> list = listPage(hql.toString(), skip, pageSize,
				queryMap);
		return list;
	}
