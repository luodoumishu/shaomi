...
@Entity
@Table(name = "CMS_ARTICLE_HISTORY")
public class CmsArticleHistory extends CMSBaseModel implements java.io.Serializable {
	...
	/**
	 * 审核节点（0-未提交审核，1-审核中，2-审核通过，3-退回）
	 */
	...
	/** default constructor */
	public CmsArticleHistory() {
	}
	
	/** full constructor */
	public CmsArticleHistory(String title, String titleColor, String titleSize,
			...
			Integer check_log, Integer top,List<CmsAffix> cmsAffixs,String behalf_image_width,String behalf_image_height) {
		this.title = title;
	...
	public boolean equals(Object obj) {
		...
		CmsArticleHistory other = (CmsArticleHistory) obj;
		if (author == null) {
